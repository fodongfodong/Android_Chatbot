...
public class Mbti_Infj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("INFJ");
        chatview_img.setImageResource(R.drawable.infj_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170099&key=IEDU5oAWX3dL13vn&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Infj.this);
        dlg.show();
