...
public class Mbti_Isfp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("ISFP");
        chatview_img.setImageResource(R.drawable.isfp_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170095&key=lt9M35qMS7naZkbu&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Isfp.this);
        dlg.show();
