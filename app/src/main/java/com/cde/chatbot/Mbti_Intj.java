...
public class Mbti_Intj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("INTJ");
        chatview_img.setImageResource(R.drawable.intj_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170094&key=Fd3PykGYffpMDZkf&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Intj.this);
        dlg.show();
