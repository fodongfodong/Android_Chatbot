...
public class Mbti_Intp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("INTP");
        chatview_img.setImageResource(R.drawable.intp_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170093&key=XPKlCrUg8TUp6pRU&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Intp.this);
        dlg.show();
