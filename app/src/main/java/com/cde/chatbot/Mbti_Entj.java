...
public class Mbti_Entj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("Entj");
        chatview_img.setImageResource(R.drawable.entj_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170086&key=ZN732AYNO50K4WBV&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Entj.this);
        dlg.show();
