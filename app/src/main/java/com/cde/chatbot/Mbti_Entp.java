...
public class Mbti_Entp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("Entp");
        chatview_img.setImageResource(R.drawable.entp_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170091&key=t5AmDRXxnutZOJKu&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Entp.this);
        dlg.show();
