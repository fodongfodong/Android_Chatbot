...
public class Mbti_Esfp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("Esfp");
        chatview_img.setImageResource(R.drawable.esfp_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170090&key=2ZKAXzmw4QCOUAxd&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Esfp.this);
        dlg.show();
