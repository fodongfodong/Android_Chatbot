...
public class Mbti_Estj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("ESTJ");
        chatview_img.setImageResource(R.drawable.estj_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170089&key=MOyiU9dmi4SNd98X&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Estj.this);
        dlg.show();
