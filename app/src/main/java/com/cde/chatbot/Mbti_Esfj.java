...
public class Mbti_Esfj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("Esfj");
        chatview_img.setImageResource(R.drawable.esfj_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170083&key=Gg5K0xKckEEXMl5J&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Esfj.this);
        dlg.show();
