...
public class Mbti_Enfj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("Enfj");
        chatview_img.setImageResource(R.drawable.enfj_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170088&key=qlyBZir93xhhX2tb&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Enfj.this);
        dlg.show();
