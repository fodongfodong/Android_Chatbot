...
public class Mbti_Istp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("ISTP");
        chatview_img.setImageResource(R.drawable.istp_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170096&key=LEueDl8SJ34FeS0I&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Istp.this);
        dlg.show();
