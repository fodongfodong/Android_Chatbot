...
public class Mbti_Infp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("INFP");
        chatview_img.setImageResource(R.drawable.infp_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170100&key=V8tJVLahjLgCcqFK&uid=[uid]&msg=" + message;
    ...
    public void dialogShow(){
        CustomDialog dlg = new CustomDialog(Mbti_Infp.this);
        dlg.show();
