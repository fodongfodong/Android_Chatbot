...
public class Mbti_Istj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("ISTJ");
        chatview_img.setImageResource(R.drawable.istj_name);
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=170097&key=VvdWJCwsuRJHGw8g&uid=[uid]&msg=" + message;
